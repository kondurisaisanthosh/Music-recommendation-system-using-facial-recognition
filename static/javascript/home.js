...
playlists.set("neutral","https://open.spotify.com/playlist/5kXFRi7s7it02gge12kGra");
playlists.set("disgust","https://open.spotify.com/playlist/4bSG6gA0zPVgiqKGStSkzV");
...
playlists.set("NO VALUE","https://open.spotify.com/embed/playlist/4SDCW3gQcNlD37XsM5ca6D");
let playlist;
...
function take_snapshot(){
    Webcam.snap(function(data_uri){
        ...
        getEmotion(newbase64img).then(data=>{playlist=playlists.get(data);console.log(playlist);document.getElementById("spotify").src=playlist});
    });
}
